...
public:
	...
	friend Chulsoo operator+(const Chulsoo& chulsooObj, const Chulsoo& chulsooObj2);
};
...
Chulsoo operator+(const Chulsoo& chulsooObj,const Chulsoo& chulsooObj2)
{
	cout << "friend 전역 연산자 오버로딩 operator+(const Chulsoo&, const Chulsoo&)"<<endl;
	cout << "=========================================================" << endl;
	Chulsoo chulsoo(chulsooObj.age + chulsooObj2.age);
	return chulsoo;
}
